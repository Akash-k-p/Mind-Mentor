...
# model_path=  os.path.join(current_directory, './model/eng_swa_model/')
# eng_swa_tokenizer = AutoTokenizer.from_pretrained(model_path)
# eng_swa_model = AutoModelForSeq2SeqLM.from_pretrained(model_path)
...
# model_path2 =  os.path.join(current_directory, './model/swa_eng_model/')

# swa_eng_model_checkpoint = "Helsinki-NLP/opus-mt-swc-en"
# swa_eng_tokenizer = AutoTokenizer.from_pretrained(model_path2)
# swa_eng_model = AutoModelForSeq2SeqLM.from_pretrained(model_path2)
...
def chatbot_response(msg):
    # response = pipeline(msg, max_length=100, do_sample=True, top_p=0.95, temperature=0.75,truncation=True)[0]["generated_text"]
